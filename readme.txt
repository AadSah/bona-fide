...
The above software is easy to modify in Netbeans IDE.
...
To run the project from the command line, go to the dist folder and type the following::   java -jar "NewProject.jar"